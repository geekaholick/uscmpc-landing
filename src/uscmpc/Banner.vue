              ...
              <div class="row align-items-center">
                <div class="col-xl-7 col-lg-7 col-md-7">
                  <div class="slider-content">
                    <div class="slider-logo">
                      <img
                        :src="getImgUrl(slider.logo)" alt="slider logo"
                      />
                    </div>
                ...
                <div class="col-xl-5 col-lg-5 col-md-5">
                  <div class="slider-thumb">
                    <img :src="getImgUrl(slider.image)" alt="slider thumb">
                  </div>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    getImgUrl(pet) {
      var images = require.context('@/assets/img/home-uscmpc/slider', false, /\.png$/)
      return images('./' + pet)
    }
  }
};
